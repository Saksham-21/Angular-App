...
@Component({
  selector: 'app-nutritionadvice-bot',
  imports: [FormsModule,CommonModule],
  templateUrl: './nutritionadvice-bot.component.html',
  styleUrl: './nutritionadvice-bot.component.css'
})
export class NutritionadviceBotComponent {
